...
static uint8_t DAP_Info(uint8_t id, uint8_t *info) {
  ...
  switch (id) {
    ...
    case DAP_ID_CAPABILITIES:
      info[0] = ((DAP_SWD  != 0U)                        ? (1U << 0) : 0U) |
                (((DAP_JTAG != 0U) && KitIsMiniProg())   ? (1U << 1) : 0U) |
                ((SWO_UART != 0U)                        ? (1U << 2) : 0U) |
                ((SWO_MANCHESTER != 0U)                  ? (1U << 3) : 0U) |
...
static uint32_t DAP_SWJ_Pins(const uint8_t *request, uint8_t *response) {
  ...
  if (((select & (1U << DAP_SWJ_TDI)) != 0U) && IsMiniProg) {
