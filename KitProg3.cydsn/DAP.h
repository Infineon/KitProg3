...
#define DAP_FW_VER_HID                  "1.2.0"
#define DAP_FW_VER_BULK                 "2.0.0"
...
__STATIC_FORCEINLINE void PIN_DELAY_SLOW (uint32_t delay) {
  ...
  while (count != 0u) {
    count--;
    /**
      * An empty __ASM directive prevents the optimizer from omitting an empty cycle
      */
    __ASM ("");
  }
}
...
// SWD implementation
#define SWD_IMPL_SW_SLOW    (0u)
#define SWD_IMPL_SW_FAST    (1u)
#define SWD_IMPL_HW         (2u)
